...
using EvaluacionDemo.Droid.Controls;
using Xamarin.Forms;
using Xamarin.Forms.Platform.Android;

[assembly: ExportRenderer(typeof(PickerImage), typeof(PickerImageRenderer))]
namespace EvaluacionDemo.Droid.Controls
{
    public class PickerImageRenderer : PickerRenderer
    {
        PickerImage element;
        public PickerImageRenderer(Context context) : base(context)
        {
        }
        protected override void OnElementChanged(ElementChangedEventArgs<Picker> e)
        {
            ...
            element = (PickerImage)this.Element;
        ...
        private BitmapDrawable GetDrawable(string imagePath)
        {
            ...
            if (resID > 0)
            {
                ...
                result = new BitmapDrawable(Resources, Bitmap.CreateScaledBitmap(bitmap, 70, 70, true));
